        ...
        Europe: {
            ...
            France: {
                ...
                Paris: {
                    ...
                    arrondissements: [
                        ...planets.earth.Europe.France.Paris.arrondissements.slice(
                            0,
                            2
                        ),
                        {
                            ...
                            inhabitants:
                                planets.earth.Europe.France.Paris
                                    .arrondissements[2].inhabitants + 1
                        },
                        ...planets.earth.Europe.France.Paris.arrondissements.slice(
                            3
                        )
...
Here the highlighted line is the information, the rest is just noise.  
